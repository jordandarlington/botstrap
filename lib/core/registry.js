...
const { githubIssueInitialActionModule } = require("../modules/github-issue-initial-action");
const {
    githubBranchProtectionStatusModule,
} = require("../modules/github-branch-protection-status");
const {
    githubDraftPullRequestCommentModule,
} = require("../modules/github-draft-pull-request-comment");
const {
    githubCheckRunFailureIssueModule,
} = require("../modules/github-check-run-failure-issue");

const moduleRegistry = [
    githubPullRequestInitialCommentModule,
    githubIssueInitialActionModule,
    githubBranchProtectionStatusModule,
    githubDraftPullRequestCommentModule,
    githubCheckRunFailureIssueModule,
];
